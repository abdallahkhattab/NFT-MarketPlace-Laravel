                   ...
                   @include('profile.partials.errors')
                    ...
                    <div class="form-row">
                        <div class="form-col">
                            <div class="nft-form-group">
                                ...
                                <input type="text" id="name" name="name" class="nft-input" value="{{ old('name', $user->name) }}" readonly>
                                @error('name')
                    ...
                    <div class="nft-form-group">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="twitter" name="twitter" class="nft-input social-input @error('twitter') is-invalid @enderror" value="{{ old('twitter', $profile->twitter) }}" placeholder="twitter">
                        </div>
                        @error('twitter')
                    ...
                    <div class="nft-form-group">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="instagram" name="instagram" class="nft-input social-input" value="{{ old('instagram', $profile->instagram) }}" placeholder="instgram">
                        </div>
                        @error('instagram')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
