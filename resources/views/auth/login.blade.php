...
<div class="min-h-screen bg-gray-900 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="bg-gray-800 p-8 rounded-2xl shadow-xl animate-fade-in">
            <h2 class="text-4xl font-bold text-white mb-4">Log In</h2>
            ...
            <p class="mt-6 text-center text-gray-400">
                Dont have an account? <a href="{{ route('register') }}" class="text-purple-400 hover:text-purple-300">Register</a>
            </p>
        </div>
    </div>
</div>
